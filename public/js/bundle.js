...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibWluZXJkIiwiYSI6ImNrdGp1NzI3azE0Z20ycW82OGVmaHh3cTUifQ.-S-xJcPcxlKSvEf4ocZgOA';
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map); //Extends to map bounds to include current location
